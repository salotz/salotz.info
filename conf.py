...
BLOG_AUTHOR = "Samuel D. Lotz"  # (translatable)
BLOG_TITLE = "Salotz's Homepage"  # (translatable)

# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://salotz.info/"

# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://salotz.info/"
BLOG_EMAIL = "samuel.lotz@salotz.info"
BLOG_DESCRIPTION = "Salotz's Homepage"  # (translatable)
